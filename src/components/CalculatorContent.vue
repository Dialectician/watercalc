<template>
 <div class="calculator-border">
        <div class="calculator-display">
          ...
          <div class="watertemperature-result" v-cloak>{{ currentT}} </div>
        </div>
          ...
          <div class="calculator-item" @click="operate('*')">*</div>
          <div class="calculator-item" @click="divided()">1/x</div>
          </div>
          ...
          <div class="calculator-row-6">
          <div class="calculator-item" @click="gallon()">GPnds</div>
          <!--<div class="calculator-item" @click="currentTemperature()">CTemp</div>-->
          
          <div class="calculator-item">
            <button v-on:click="currentTemperature">CTemp</button>
          </div>
          <div class="calculator-item" @click="gallon()">TTemp</div>
...
export default {
  ...
  methods:{
    //(Btu) is the energy required to raise one pound of water by one degree Fahrenheit. 
//U.S. gallon of water weighs 8.3 pounds
/*to raise one
gallon of 55°F water up to 120°F would require (1 × 8.3 × (120 − 55)) = 540
Btu. 
*/
    currentTemperature: function (event){
      var t_result = this.formula;
      this.currentT = t_result;
      
    },
    
    gallon: function(){
      var gWeight = 8.3
      var gConversion = this.formula*gWeight;
      this.result = gConversion;
      this.formula = gConversion;
      console.log(gConversion);
...
.calculator .calculator-border .calculator-items .calculator-row-6{
  /*border: 1px solid blue;*/
  margin-bottom: 2.3%;
  width: 100%
}
...
.calculator .calculator-border .calculator-row-6 .calculator-item:nth-child(4){
  margin-right: 0;
